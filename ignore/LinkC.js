...
async function getButtonInfo() {
  ...
  // if (
  //   (data.values.button1 === 1 && data.values.button2 === 0) ||
  //   (data.values.button1 === 0 && data.values.button2 === 1)
  // ) {
  //   if (data.values.button1 === 1 && checkOverlap()) {
  //     //getInfo button selected - show country/ blown up pictures on screen
  //     openCarousel(carouselIndex, carouselCountry, countryCoordinates);
  //   }
  //   if (data.values.button2 === 1) {
  //     //goBack button selected - show compass on phone/ map on screen
  //     document.getElementById("overlay").style.display = "none";
  //     if (window.mySwiper) {
  //       window.mySwiper.slideTo(0, 0);
  //     }
